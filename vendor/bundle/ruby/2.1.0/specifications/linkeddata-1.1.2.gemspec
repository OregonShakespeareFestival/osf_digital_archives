# -*- encoding: utf-8 -*-
# stub: linkeddata 1.1.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rdf-json>, ["~> 1.1"])
      s.add_runtime_dependency(%q<rdf-microdata>, ["~> 2.0"])
      s.add_runtime_dependency(%q<rdf-n3>, ["~> 1.1"])
      s.add_runtime_dependency(%q<rdf-rdfa>, [">= 1.1.5", "~> 1.1"])
      s.add_runtime_dependency(%q<rdf-rdfxml>, [">= 1.1.3", "~> 1.1"])
      s.add_runtime_dependency(%q<rdf-reasoner>, [">= 0.2.1", "~> 0.2"])
      s.add_runtime_dependency(%q<rdf-trig>, [">= 1.1.3", "~> 1.1"])
      s.add_runtime_dependency(%q<rdf-trix>, ["~> 1.1"])
      s.add_runtime_dependency(%q<rdf-turtle>, [">= 1.1.5", "~> 1.1"])
      s.add_runtime_dependency(%q<json-ld>, [">= 1.1.7", "~> 1.1"])
      s.add_runtime_dependency(%q<sparql>, [">= 1.1.4", "~> 1.1"])
      s.add_runtime_dependency(%q<sparql-client>, [">= 1.1.3", "~> 1.1"])
      s.add_runtime_dependency(%q<nokogiri>, ["~> 1.6"])
      s.add_runtime_dependency(%q<equivalent-xml>, ["~> 0.4"])
      ...
      s.add_dependency(%q<rdf-json>, ["~> 1.1"])
      s.add_dependency(%q<rdf-microdata>, ["~> 2.0"])
      s.add_dependency(%q<rdf-n3>, ["~> 1.1"])
      s.add_dependency(%q<rdf-rdfa>, [">= 1.1.5", "~> 1.1"])
      s.add_dependency(%q<rdf-rdfxml>, [">= 1.1.3", "~> 1.1"])
      s.add_dependency(%q<rdf-reasoner>, [">= 0.2.1", "~> 0.2"])
      s.add_dependency(%q<rdf-trig>, [">= 1.1.3", "~> 1.1"])
      s.add_dependency(%q<rdf-trix>, ["~> 1.1"])
      s.add_dependency(%q<rdf-turtle>, [">= 1.1.5", "~> 1.1"])
      s.add_dependency(%q<json-ld>, [">= 1.1.7", "~> 1.1"])
      s.add_dependency(%q<sparql>, [">= 1.1.4", "~> 1.1"])
