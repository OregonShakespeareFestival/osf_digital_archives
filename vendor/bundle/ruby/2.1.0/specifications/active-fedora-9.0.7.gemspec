# -*- encoding: utf-8 -*-
# stub: active-fedora 9.0.7 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<active-triples>, ["~> 0.6.0"])
      ...
      s.add_runtime_dependency(%q<ldp>, ["~> 0.2.1"])
      s.add_runtime_dependency(%q<rdf-ldp>, [">= 0"])
