# -*- encoding: utf-8 -*-
# stub: blacklight 5.12.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rsolr>, ["~> 1.0.11"])
      s.add_runtime_dependency(%q<bootstrap-sass>, ["~> 3.2"])
      ...
      s.add_dependency(%q<engine_cart>, [">= 0.6.0"])
